...
angular.module('angular-momentum-scroll-custom', []);
 ...
 *      momentum: false} }}"">...</div>
 */
angular.module('angular-momentum-scroll-custom').directive('scrollable',
    ...
    return {
      ...
      //define handlers
      	var handleScrollStart=function(){
      		if(angular.isDefined(scope.onScrollStart)){
      			scope.disableClick();
      		}
      	};
        ...
        var _init = function() {
          ...
          iScrollInstance.on('scrollStart',handleScrollStart);
